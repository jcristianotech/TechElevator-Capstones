...
public class JdbcSurveyDao implements SurveyDao {
	...
	public void insertSurvey(Survey survey) {
		...
		survey.setSurveyId(jdbcTemplate.queryForObject(sql, Long.class, survey.getParkCode(), survey.getEmailAddress(),
	...
	public List<SurveyResult> getSurveyResults() {
		...
		String sql = "SELECT count(*) as votes, park.parkcode, park.parkname " + "FROM survey_result "
				+ "JOIN park on park.parkcode = survey_result.parkcode " + "GROUP BY park.parkcode, park.parkname "
